...
+ Recuperamos el dataFrame guardado en el fichero .rds.
+ Recogemos el tweet
+ Limpiamos el tweets quitando comas, números, link html, espacios, caracteres raros (@, ^, \\, :, etc.)
...
+ Creamos una matrix que contiene por una parte el número de tweets y por otra el nombre del ataque.
